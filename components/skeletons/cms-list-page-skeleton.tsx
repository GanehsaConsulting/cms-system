...
interface CmsListPageSkeletonProps {
  /** When true, show a detail panel column (articles / clients workspace). */
  withDetailPanel?: boolean;
}

/** Placeholder for CMS list pages: header, toolbar, table, optional detail. */
export function CmsListPageSkeleton({
  withDetailPanel = true,
}: CmsListPageSkeletonProps) {
  return (
    <div
      className={cn(
